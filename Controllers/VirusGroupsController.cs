...
namespace NewVirusApp.Controllers
{
    public class VirusGroupsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,GroupName,GroupInfo,DateDiscovered")] VirusGroup virusGroup)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,GroupName,GroupInfo,DateDiscovered")] VirusGroup virusGroup) {
            if (id != virusGroup.Id) {
                return NotFound();
            }
